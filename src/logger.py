...
def setLogging():
    ...
    file_handler_error = logging.FileHandler("RecipeBook-errors.log", mode='a')
    file_handler_error.setFormatter(log_formatter)
    file_handler_error.setLevel(logging.WARNING)
    file_handler_error.encoding = "utf-8"
    logging.getLogger().addHandler(file_handler_error)

    file_handler_info = logging.FileHandler("RecipeBook-info.log", mode='a')
    ...
    file_handler_other = logging.FileHandler("RecipeBook-other.log", mode='a')
